...
plt.legend()
plt.grid(True)
plt.savefig(f"results/avg_surgery_cost.png")
...
plt.legend()
plt.grid(True)
plt.savefig(f"results/avg_surgery_time.png")
...
plt.legend()
plt.grid(True)
plt.savefig(f"results/avg_compl_time.png")
...
plt.legend()
plt.grid(True)
plt.savefig(f"results/IO_rate.png")
print("Average rate: ")
